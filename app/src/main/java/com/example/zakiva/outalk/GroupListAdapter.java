...
public class GroupListAdapter extends FirebaseListAdapter<GroupInfo> {
    ...
    public GroupListAdapter(Query ref, Activity activity, int layout, String mUsername) {
        super(ref, GroupInfo.class, layout, activity);
     ...
     * @param groupInfo An instance representing the current state of a chat message
     */
    @Override
    protected void populateView(View view, GroupInfo groupInfo) {
        ...
        groupNameButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                chat.putExtra("username", mUsername);
